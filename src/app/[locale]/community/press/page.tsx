...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "Community.press" });
...
export default async function PressPage({
  ...
  const sw = sp.sw ?? "";
  const t = await getTranslations("Community.press");
  ...
  return (
    ...
    >
      <BoardList boardId={BOARD_ID} posts={posts} total={total} page={page} basePath="/community/press" searchWord={sw} />
    </SubPageLayout>
  );
}
